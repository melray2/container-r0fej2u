...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-r0fej2u.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-r0fej2u.containers.anotherwebservice.com/
...
```
git clone git@github.com:melray2/container-r0fej2u.git
cd container-r0fej2u
```
...
```
docker attach container-r0fej2u
```
